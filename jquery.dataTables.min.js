    ...
    null != y &&
        (l
            ...
            : y !== A &&
              ...
              $jscomp.defineProperty(q, E, { configurable: !0, writable: !0, value: y })));
};
$jscomp.polyfill(
...
(function (l) {
    ...
    function Fb(a) {
        if (!u.__browser) {
            ...
            u.__browser = b;
            var c = l("<div/>")
                    .css({ position: "fixed", top: 0, left: -1 * l(y).scrollLeft(), height: 1, width: 1, overflow: "hidden" })
                    .append(
                        l("<div/>")
        ...
        if (-1 !== l.inArray(!1, c)) V(a, !1);
            ...
            if (0 !== k.length)
                ...
                (e = f.sZeroRecords),
                    ...
                    (c[0] = l("<tr/>", { class: h ? d[0] : "" }).append(l("<td />", { valign: "top", colSpan: na(a), class: a.oClasses.sRowEmpty }).html(e))[0]);
    ...
    function Ja(a) {
        ...
        if (a.scrollBarVis !== X && a.scrollBarVis !== q) (a.scrollBarVis = X), sa(a);
            ...
            Math.round(w.outerWidth()) < Math.round(h)
                ? ((ca = g.scrollHeight > g.offsetHeight || "scroll" == n.css("overflow-y") ? h + b : h),
    ...
    function db(a) {
        ...
        if (d || (!t && !h && !e && g == na(a) && g == m.length)) for (v = 0; v < g; v++) (k = ta(a, v)), null !== k && (c[k].sWidth = K(m.eq(v).width()));
        else {
    ...
    function Ea(a, b) {
        ...
        b <= c
            ...
            : (a >= b - 1 - d ? (a = pa(b - (c - 2), b)) : ((a = pa(a - d + 2, a + d - 1)), a.push("ellipsis"), a.push(b - 1)), a.splice(0, 0, "ellipsis"), a.splice(0, 0, 0));
        a.DT_el = "span";
        return a;
    }
    function bb(a) {
                        ...
                        l(ba[0])
                            ...
                            .each(function (I, H) {
                                ...
                                if (fa.mData === I) {
                                    ...
                                    if (null !== Z || null !== H) (fa.mData = { _: I + ".display", sort: null !== Z ? I + ".@data-" + Z : q, type: null !== Z ? I + ".@data-" + Z : q, filter: null !== H ? I + ".@data-" + H : q }), Ia(r, I);
                                }
                            });
                    }
                    var O = r.oFeatures;
    ...
    var Hc = function (a, b, c, d) {
        ...
        xc = function (a, b) {
            ...
            if (c.length && a.length) {
                ...
                d._details &&
                    ((d._detailsShow = b) ? (d._details.insertAfter(d.nTr), l(d.nTr).addClass("dt-hasChild")) : (d._details.detach(), l(d.nTr).removeClass("dt-hasChild")), F(c[0], null, "childRow", [b, a.row(a[0])]), Ic(c[0]), wc(c));
            }
        },
        Ic = function (a) {
            var b = new B(a),
